...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->splitContainer1->Size = System::Drawing::Size(1659, 671);
			...
			this->splitContainer2->Size = System::Drawing::Size(837, 671);
			...
			this->listBox1->Items->AddRange(gcnew cli::array< System::Object^  >(7) {
				L"* for Ticket_ID please ", L"   enter 1 not 01 ",
					L"* for Flight Number please ", L"   enter alphabets in ", L"   Captial Letters", L"* Remaining please enter in ", L"   small characters"
			});
			this->listBox1->Location = System::Drawing::Point(587, 107);
			this->listBox1->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->listBox1->Name = L"listBox1";
			this->listBox1->Size = System::Drawing::Size(185, 128);
			...
			this->label8->Location = System::Drawing::Point(55, 63);
			this->label8->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label8->Name = L"label8";
			this->label8->Size = System::Drawing::Size(283, 35);
			this->label8->TabIndex = 3;
			this->label8->Text = L"Book your ticket here";
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(207, 174);
			...
			// textBox1
			// 
			this->textBox1->Location = System::Drawing::Point(207, 110);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(449, 228);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(449, 107);
			...
			this->label2->Location = System::Drawing::Point(55, 177);
			...
			this->label1->Location = System::Drawing::Point(55, 113);
			...
			// textBox4
			// 
			this->textBox4->Location = System::Drawing::Point(207, 298);
			...
			this->label4->Location = System::Drawing::Point(55, 302);
			...
			this->label3->Location = System::Drawing::Point(55, 240);
			this->label3->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(90, 16);
			this->label3->TabIndex = 2;
			this->label3->Text = L"Flight Number";
			this->label3->Click += gcnew System::EventHandler(this, &MyForm::label3_Click);
			// 
			// textBox3
			// 
			this->textBox3->Location = System::Drawing::Point(207, 236);
			...
			this->listBox2->Items->AddRange(gcnew cli::array< System::Object^  >(7) {
				L"* for Ticket_ID please ", L"  enter 1 not 01.",
					L"* for Flight Number please ", L"  enter alphabets in ", L"   Captial Letters.", L"* Enter all details in", L"  Captial Letters. "
			});
			this->listBox2->Location = System::Drawing::Point(587, 170);
			this->listBox2->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->listBox2->Name = L"listBox2";
			this->listBox2->Size = System::Drawing::Size(185, 128);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Times New Roman", 18, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label7->Location = System::Drawing::Point(55, 97);
			this->label7->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label7->Name = L"label7";
			this->label7->Size = System::Drawing::Size(473, 35);
			this->label7->TabIndex = 10;
			this->label7->Text = L"Check your Ticket confirmation here";
			// 
			// textBox6
			// 
			this->textBox6->Location = System::Drawing::Point(207, 249);
			...
			// textBox5
			// 
			this->textBox5->Location = System::Drawing::Point(207, 172);
			...
			this->label6->Location = System::Drawing::Point(55, 252);
			this->label6->Margin = System::Windows::Forms::Padding(4, 0, 4, 0);
			this->label6->Name = L"label6";
			this->label6->Size = System::Drawing::Size(94, 16);
			this->label6->TabIndex = 7;
			this->label6->Text = L"Flight_Number";
			// 
			// label5
			// 
			this->label5->AutoSize = true;
			this->label5->Location = System::Drawing::Point(55, 176);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(449, 246);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(449, 170);
			...
			this->pictureBox2->Location = System::Drawing::Point(36, 33);
			this->pictureBox2->Margin = System::Windows::Forms::Padding(4, 4, 4, 4);
			this->pictureBox2->Name = L"pictureBox2";
			this->pictureBox2->Size = System::Drawing::Size(392, 246);
			...
			this->menuStrip1->Size = System::Drawing::Size(1659, 29);
			...
			this->displayFileContentToolStripMenuItem->Size = System::Drawing::Size(107, 25);
			this->displayFileContentToolStripMenuItem->Text = L"Display File ";
			// 
			// openToolStripMenuItem
			// 
			this->openToolStripMenuItem->Name = L"openToolStripMenuItem";
			this->openToolStripMenuItem->Size = System::Drawing::Size(132, 26);
			...
			this->disToolStripMenuItem->Size = System::Drawing::Size(147, 25);
			this->disToolStripMenuItem->Text = L"Display Ticket List";
			// 
			// openToolStripMenuItem1
			// 
			this->openToolStripMenuItem1->Name = L"openToolStripMenuItem1";
			this->openToolStripMenuItem1->Size = System::Drawing::Size(132, 26);
			...
			this->ClientSize = System::Drawing::Size(1659, 671);
